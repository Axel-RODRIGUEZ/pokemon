...
class DisplayStarterMenu(Display):
    ...
    def __init__(self, screen: Surface, fonts: tuple[font.Font, font.Font]):
        ...
        self.__dialog_box_large = transform.scale(self.__dialog_box,(1302,800))
